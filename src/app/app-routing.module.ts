...
const routes: Routes = [
  { path: '', component: HomeComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'home' } }, //default library of user
  { path: 'item/:bibId', component: ItemComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'bibId', appPath: 'item' } },
  { path: 'item/itemId/:itemId', component: ItemComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'itemId', appPath: 'item' } },
  { path: 'search/reserves', component: ReservesComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'browse', appPath: 'reserves' }},
  { path: 'search/reserves/course/:courseId', component: ReservesComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'details', appPath: 'reserves' }},
  { path: 'search/reserves/:browseMode/:searchTerm', component: ReservesComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'browse', appPath: 'reserves' }},
  { path: 'my', component: MyComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'my', appPath: 'my' } },
  { path: 'return', component: MyComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'return', appPath: 'my' } },
  { path: 'read', component: MyComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, mode: 'read', appPath: 'my' } },
  { path: 'reader', component: ReaderComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'reader' } },
  // { path: 'reader2', component: ReaderComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'reader', mode: 1 } },
  { path: 'about', component: AboutComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'about' } },
  { path: 'stats', component: StatsComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'stats' } },
  { path: 'admin', component: AdminComponent, canActivate: [AuthGuard], data: { isUsersDefaultLibrary: true, appPath: 'admin' } },
  ...
  { path: 'error-no-library', component: ErrorComponent, canActivate: [AuthGuard], data: { mode: 'unknownLibrary', appPath: 'error'}},
  ...
  { path: 'logged-out', component: PageComponent, data: { isUsersDefaultLibrary: true, mode: 'loggedOut', appPath: 'page'}},
